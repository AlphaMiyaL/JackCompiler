...
/**
 * @author Brian Song
 * @description gets its input from a JackTokenizer and writes output to an output file. 
 * The output is generated by a series of compile routines, each designed to handle the 
...
public class CompilationEngine {
    ...
    /**
     * Compiles a parameter list that can possibly be empty.
     * Does not handle enclosing parenthesis tokens
     ...
     * Does not handle enclosing curly brackets tokens
     */
     ...
     * possibly with trailing else clause
     */
    ...
    /**
     * Compiles a term
     * If current token is an identifier, routine must resolve into a variable, array element, or subroutine call
     * Any other tokens are not part of this term and are not advanced over
     */
    ...
    /**
     * Compiles a possibly empty list of comma seperated list of expressions
     * prints compiled expression list and returns
